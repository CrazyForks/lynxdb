...
func buildLFFuncSpecs() []lfFuncSpec {
	return []lfFuncSpec{
		...
		{name: "normalize_utf8", minArgs: 1, maxArgs: 2, emit: lfEmitVariadicOp(OpNormalizeUTF8)},
		{name: "punycode_encode", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpPunycodeEncode)},
		{name: "punycode_decode", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpPunycodeDecode)},
		...
		{name: "base64url_decode", minArgs: 1, maxArgs: 1, strict: true, emit: lfEmitUnary(OpBase64URLDecode),
			emitStrict: lfStrictCast("base64url_decode", OpBase64URLDecode)},
		{name: "base64url_encode", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpBase64URLEncode)},
		{name: "hex", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpHex)},
		...
		{name: "has_any", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpHasAny)},
		{name: "has_all", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpHasAll)},
		{name: "contains_phrase", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpContainsPhrase)},
		{name: "contains_any", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpContainsAny)},
		{name: "contains_any_cs", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpContainsAnyCS)},
		{name: "matches_any", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpMatchesAny)},
		...
		{name: "array_sum", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpArraySum)},
		{name: "array_avg", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpArrayAvg)},
		{name: "array_min", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpArrayMin)},
		{name: "array_max", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpArrayMax)},
		...
		{name: "entries", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpEntries)},
		{name: "from_entries", minArgs: 1, maxArgs: 1, emit: lfEmitUnary(OpFromEntries)},
		...
		{name: "json_value", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpJsonValue)},
		{name: "json_query", minArgs: 2, maxArgs: 2, emit: lfEmitBinary(OpJsonQuery)},
	}
}
