...
- **Sigma rule support** - run [rsigma-generated](https://github.com/timescale/rsigma) SPL2, for example `lynxdb query "$(rsigma convert -t lynxdb rule.yml)"`; see [docs/sigma](docs/sigma/index.md)
