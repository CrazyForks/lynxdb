...
| `rsigma says rule X is unsupported` | rsigma could not convert the Sigma construct for the LynxDB backend. | Check the upstream rsigma issue tracker and file a minimal rule if one does not exist: <https://github.com/timescale/rsigma/issues>. |
