...
`avg`, `count`, `distinct_count` / `dc`, `estdc`, `estdc_error`, `first`, `last`, `list`, `mad`, `max`, `mean`, `median`, `min`, `mode`, `range`, `stdev`, `stdevp`, `sum`, `sumsq`, `top_k_weighted`, `var`, `varp`, `values`.
